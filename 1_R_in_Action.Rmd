...
Integers bigger than 2^50 -> converted to a floating point number with precision -> algorithm will fail.
So for cryptographic uses, we need to use packages that allow bigger precise integers.
In Python, we don't have this issues.
